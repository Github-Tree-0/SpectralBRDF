...
int main(int argc, char **argv) {
    ...
    // load a BRDF
    BRDF brdf("/mnt/workspace2019/heng/project/MultiSpectralPhotometricStereo/third_party/rendering/brdf-wrapper/data/isotropic/cc_ibiza_sunset_spec.bsdf");
